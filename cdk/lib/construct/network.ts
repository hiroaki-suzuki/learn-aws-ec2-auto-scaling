...
export class Network extends Construct {
  ...
  private createVpc(namePrefix: string, envValues: EnvValues): IVpc {
  ...
  private renameSubnet(namePrefix: string, vpc: IVpc) {
  ...
  private renameIGW(namePrefix: string, vpc: IVpc) {
